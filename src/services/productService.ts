...
import { Timestamp } from 'firebase/firestore'; // Keep for type consistency if needed, but not for functionality
...
const MOCK_PRODUCTS: Product[] = [
    {
        ...
        brand: 'TechNova', stock: 50, isFeatured: true, isWeeklyDeal: false, createdAt: Timestamp.now()
    },
    {
        ...
        brand: 'UrbanStyle', stock: 120, isFeatured: false, isWeeklyDeal: true, createdAt: Timestamp.now()
    },
    {
        ...
        brand: 'KitchenMaster', stock: 30, isFeatured: true, isWeeklyDeal: false, createdAt: Timestamp.now()
    },
    {
        ...
        brand: 'AudioPhile', stock: 40, isFeatured: true, isWeeklyDeal: true, createdAt: Timestamp.now()
    },
    {
        ...
        brand: 'PureLeaf', stock: 200, isFeatured: false, isWeeklyDeal: true, createdAt: Timestamp.now()
    }
];
