...
export const metadata: Metadata = {
  title: 'About Us - Creme Lite',
  description: 'Learn more about Creme Lite, our mission, vision, and values.',
};
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold text-center text-primary mb-8 font-headline">About Creme Lite</h1>
        
        <div className="prose prose-lg dark:prose-invert max-w-none text-foreground">
          <p className="lead">
            Welcome to Creme Lite, your premier destination for finding unique and high-quality products. We are passionate about connecting customers with exceptional items that enhance their lifestyle.
          </p>
          ...
          <p>
            We envision Creme Lite as a leading e-commerce platform recognized for its commitment to customer satisfaction, ethical business practices, and a diverse range of inspiring products. We aim to continuously adapt and innovate to meet the evolving needs of our customers.
          </p>
          ...
          <p className="mt-8">
            Thank you for choosing Creme Lite. We look forward to serving you!
          </p>
        </div>
      </div>
    </div>
