...
import { 
  ...
  Bike, ToyBrick, Car, BookMarked, HeartPulse, Dumbbell, Tent, Gamepad2, PencilRuler, Stethoscope, Popcorn, Coffee, Cookie, Gavel, Store, Gift, ListOrdered, MapPin, Inbox
} from 'lucide-react';
